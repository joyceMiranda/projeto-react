...
app.post('/tarefas', async (req, res) => {
    try{
      ...
      await connection.query('INSERT INTO tarefas (titulo, uid) VALUES ($1, $2)', [tarefa.titulo, tarefa.uid]);
...
app.put('/tarefas/:id', async (req, res) => {
  try{
    const { id } = req.params;
    const tarefa = req.body;
    await connection.query('UPDATE tarefas SET titulo = $1, finalizada = $2 WHERE id = $3', [tarefa.titulo, tarefa.finalizada, id]);
